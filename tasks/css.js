...
module.exports = function(grunt) {
  ...
  grunt.task.registerMultiTask('css', 'Concats, replaces @imports and minifies the CSS files', function() {
    ...
    var files = grunt.file.expandFiles(this.data.src || this.data);

    //The output destination is the value of the dest key or subtarget name
    var target = this.file.dest || this.target;
